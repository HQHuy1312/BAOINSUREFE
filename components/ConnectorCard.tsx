...
const ConnectorCard: React.FC<ConnectorCardProps> = ({ connector, onClick, isLoading, connectionsCount }) => {
  ...
  return (
    <div className={cardClasses}>
      ...
      >
        ...
        ) : isImplemented ? (isConnected ? 'Manage' : 'Connect your data') : 'Coming Soon'}
      </button>
    </div>
  );
};
